...
import { getOpenPharmacy } from '../api/pharmacy.api'
...
export const useFetchPharmacy = () => {
    ...
    const [data, setData] = useState<IState<Pharmacy[]>>({ loading: false, data: EMPTY_PHARMACY });
